...
public class Cell {
	...
	public Cell(int row, int col) {
		...
		this.row = row; //sets row to current row
	    this.col = col; //Sets col to current col
	    clear(); //Calls the clear method to make sure the cells content are empty
	   }
	...
	public void clear() {
		...
		content = Player.Empty; //Sets the cell contents to empty by calling using the Player enum 'empty' rather than a nought or cross.
